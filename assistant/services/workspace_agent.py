...
class WorkspaceAgentService:
    ...
    def review_objective(self, objective: str) -> str:
        ...
        review_context = (
            ...
            "- Si un valor de secreto es un placeholder claro (por ejemplo replace-me, changeme, example), no lo trates como fuga real.\n"
            "- Cada riesgo o mejora debe citar al menos una evidencia (archivo o matriz).\n"
            "- Formato obligatorio en riesgos: EVIDENCIA: <archivo/ruta exacta> + <hecho FACTS_JSON o matriz>.\n"
